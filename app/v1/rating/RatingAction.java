...
public class RatingAction extends play.mvc.Action.Simple {
    private final Logger logger = LoggerFactory.getLogger("application.RatingAction");
    ...
    @Singleton
    @Inject
    public RatingAction(MetricRegistry metrics, HttpExecutionContext ec, Futures futures) {
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(RatingAction.class, "responsesTimer"));
    }
